...
public class blueLeft extends LinearOpMode{
    ...
    public void runOpMode() /*throws InterruptedException*/ {
        ...
        /*CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        //Pickup Stack
                        new PositionCommand(drivetrain, localizer, new Pose(48.5, 69, -Math.PI/2), 0, robot.getVoltage()),
                        new IntakeCommand(intake, IntakeSubsystem.IntakeState.INWARDS)
                                .alongWith(new WaitCommand(1250)),
                        //new IntakeCommand(intake, IntakeSubsystem.IntakeState.OFF),
                        //Deposit Stack
                        new PositionCommand(drivetrain, localizer, new Pose(48.5, -40, Math.PI/2+Math.toRadians(27.5)), 0, robot.getVoltage()),
                        new IntakeCommand(intake, IntakeSubsystem.IntakeState.OUTWARDS)
                        ...
                        //Pickup Stack 2
                        new PositionCommand(drivetrain, localizer, new Pose(34, 68.5, -Math.PI/2), 0, robot.getVoltage()),
                        new IntakeCommand(intake, IntakeSubsystem.IntakeState.INWARDS)
                                .alongWith(new WaitCommand(1250)),
                        //new IntakeCommand(intake, IntakeSubsystem.IntakeState.OFF),
    ...
    // public static int getModifier(){return Globals.SIDE == Globals.Side.LEFT ? 1 : -1;}
}
