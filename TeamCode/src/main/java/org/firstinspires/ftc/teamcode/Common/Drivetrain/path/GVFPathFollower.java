...
import org.firstinspires.ftc.teamcode.Common.Drivetrain.geometry.Spline;
...
public class GVFPathFollower {
    ...
    private final double MAX_VELOCITY = SwerveConstants.MAX_LINEAR_SPEED - 20; /* Inches per second */
    private final double MAX_ACCEL = SwerveConstants.MAX_LINEAR_ACCELERATION; /* Inches per second squared */
    private final double MAX_DECEL = SwerveConstants.MAX_LINEAR_ACCELERATION; /* Inches per second squared */
