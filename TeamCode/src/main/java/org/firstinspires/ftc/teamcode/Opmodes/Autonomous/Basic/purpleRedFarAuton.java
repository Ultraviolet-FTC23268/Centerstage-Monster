...
public class purpleRedFarAuton extends CommandOpMode {
    ...
    public static double preYellowPosX = 87;
    public static double preYellowPosY= 48;
...
//                .setStreamFormat(VisionPortal.StreamFormat.MJPEG)
        ...
        switch (side) {
            case RIGHT:
                ...
                preYellowScorePos = new Pose(preYellowPosX, preYellowPosY, 5*Math.PI/3);
            ...
            case CENTER:
                ...
                preYellowScorePos = new Pose(87, 48, 5*Math.PI/3);
