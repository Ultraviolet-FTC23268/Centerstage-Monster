package org.firstinspires.ftc.teamcode.Funny.Drivetrain.swerve;

import static org.firstinspires.ftc.teamcode.Funny.Utility.Globals.USE_WHEEL_FEEDFORWARD;
...
import org.firstinspires.ftc.teamcode.Funny.Drivetrain.geometry.MathUtils;
...
public class SwerveDrivetrain implements Drivetrain {
    ...
    public static double frontLeftOffset = .17, frontRightOffset = 1, backLeftOffset = -.3, backRightOffset = 1.1; //1.49, 1.5, 1.72, 1.48
    ...
    public static double minPow = 0.18;
